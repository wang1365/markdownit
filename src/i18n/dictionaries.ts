...
export const dictionaries: Record<Locale, Dictionary> = {
  en: {
    ...
    app: {
      ...
      exportNotion: "Notion",
      copiedGoogle: "Rich text copied. Paste it into the new Google Doc.",
  ...
  fr: {
    ...
    app: {
      ...
      exportGoogle: "Google Docs",
      exportNotion: "Notion",
      copiedGoogle: "Texte enrichi copié. Collez-le dans le nouveau Google Doc.",
  ...
  de: {
    ...
    app: {
      ...
      exportGoogle: "Google Docs",
      exportNotion: "Notion",
      copiedGoogle: "Formatierter Text kopiert. Füge ihn in das neue Google Doc ein.",
  ...
  ja: {
    ...
    app: {
      ...
      exportGoogle: "Google Docs",
      exportNotion: "Notion",
      copiedGoogle: "リッチテキストをコピーしました。新しい Google ドキュメントに貼り付けてください。",
  ...
  ko: {
    ...
    app: {
      ...
      exportGoogle: "Google Docs",
      exportNotion: "Notion",
      copiedGoogle: "서식 있는 텍스트를 복사했습니다. 새 Google Docs에 붙여넣으세요.",
  ...
  "zh-CN": {
    ...
    app: {
      ...
      exportNotion: "Notion",
      copiedGoogle: "已复制富文本，请粘贴到新打开的 Google 文档。",
  ...
  "zh-TW": {
    ...
    app: {
      ...
      exportNotion: "Notion",
      copiedGoogle: "已複製富文字，請貼到新開啟的 Google 文件。",
  ...
  ar: {
    ...
    app: {
      ...
      exportGoogle: "Google Docs",
      exportNotion: "Notion",
      copiedGoogle: "تم نسخ النص المنسق. الصقه في مستند Google الجديد.",
