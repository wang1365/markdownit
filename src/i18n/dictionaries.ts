...
export const dictionaries: Record<Locale, Dictionary> = {
  en: {
    ...
    app: {
      ...
      exportPdf: "PDF",
      exportGoogle: "Export to Google Docs",
      exportNotion: "Notion",
  ...
  fr: {
    ...
    app: {
      ...
      import: "Importer",
      exportMd: "Markdown",
      exportWord: "Télécharger Word",
      exportPdf: "PDF",
      exportGoogle: "Exporter vers Google Docs",
      exportNotion: "Notion",
  ...
  de: {
    ...
    app: {
      ...
      import: "Import",
      exportMd: "Markdown",
      exportWord: "Word herunterladen",
      exportPdf: "PDF",
      exportGoogle: "Zu Google Docs exportieren",
      exportNotion: "Notion",
  ...
  ja: {
    ...
    app: {
      ...
      import: "読み込み",
      exportMd: "Markdown",
      exportWord: "Word でダウンロード",
      exportPdf: "PDF",
      exportGoogle: "Google ドキュメントへ書き出し",
      exportNotion: "Notion",
  ...
  ko: {
    ...
    app: {
      ...
      import: "가져오기",
      exportMd: "Markdown",
      exportWord: "Word로 다운로드",
      exportPdf: "PDF",
      exportGoogle: "Google Docs로 내보내기",
      exportNotion: "Notion",
  ...
  ar: {
    ...
    app: {
      ...
      exportPdf: "PDF",
      exportGoogle: "تصدير إلى Google Docs",
      exportNotion: "Notion",
